#!/usr/bin/env python3
"""
Merge stage-1 MiniMax results with one additional model for boundary samples.

The first vote is the existing stage-1 classification. The second vote is a
new single-model classification over boundary candidates. Agreement rows are
finalized; split rows are kept for review or optional third-model arbitration.
"""
...
def main() -> None:
    ...
    parser.add_argument("--prefix", default="dual_vote_boundary")
